        ...
        return(
            <div className="searchPage">
                ...
                <div className="container">
                    ...
                    <p className="text-center">Max Api Request available : { user === 'Luke Skywalker' ? 'Unlimited' : searchCount }</p>
                    ...
                    <div className="planets">
                        { isLoaded ? <div className="text-center"><i className="fas fa-spin fa-sync-alt"></i></div> :
                            ...
                            (planets.length > 0 && search !== "") ?
                                ...
                                </ul> : search !== '' && <div className="text-center">Your maximum limit has reached.</div>
                        }
                    </div>
                </div>
            </div>
